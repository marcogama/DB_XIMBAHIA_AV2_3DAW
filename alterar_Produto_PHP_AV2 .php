<?php
	...
	$p = intval($_GET['p']);
               ...
               $sql="SELECT NOME, NOME_FABR, CATEG, TIPO, PRECO_VENDA, QUANT_EST, PESO, DESCR, IMG, D_INCL, ATIVO  FROM PRODUTO WHERE CODBAR = '".$p."'";
               ...
               if($resultado->num_rows>0){
                       while($dados = $resultado->fetch_assoc()){
                               ...
                               echo "<input type = 'submit' value = 'altera'>";
