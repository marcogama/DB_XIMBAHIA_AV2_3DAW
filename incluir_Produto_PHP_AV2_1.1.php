                                                                        ...
                                                                        if(empty($AT1) && empty($AT2){
                                                                            ...
                                                                            if(isset($AT1)){
                                                                              $ATIVO = 1;
                                                                                ...
                                                                                if(isset($AT2){
                                                                                    $ATIVO = 0;                                                                                                                 }else{
$sql = "INSERT INTO PRODUTO(NOME, NOME_FABR, CATEG, TIPO, PRECO_VENDA,QUANT_EST, PESO, IMG, DT_INC, ATIVO)
        VALUES("$NOME.",".$NOME_FABR.",".$CATEG.",".$TIPO.",".$PRECO_VENDA.",".$QUANT_EST.",".$PESO.",".
                $IMG.",".$D_INCL.",".$DESCR.",".$ATIVO.")";
$sql .= "SELECT CODBAR FROM XIMBAHIA WHERE NAME = ".$NAME."";
                                                                                    ...
                                                                                    if((substr($IMG,-4) == $_JPG){
	                                                                                     ...
	                                                                                     $IMG = substr_replace
                                                                                                ($STR_TMP,$CODBAR,$IMG);
																						 $sql .= "UPDATE XIMBAHIA SET IMG = 
                                                                                         ".$IMG." WHERE CODBAR = ".$CODBAR."";
                                                                                    }else{
                                                                                        if(substr($IMG, -4) != $_JPG){                                                                                                     echo "Erro, v8.1";                                                                                                         }else{                                                                                                                             if($conn->mult-query($sql)===TRUE){
                                                                                                echo "Registro inserido com 
                                                                                                      sucesso";
                                                                                            }else{                                                                                                                             echo "Erro, registro";
                                                                                            }
																						}
                                                                                    }
																				}
